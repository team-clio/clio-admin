...
export function Sidebar({ page, navigate, className = '', onClose, projects, selectedProjectId, setSelectedProjectId, projectsLoading, projectsError, onCreateProject }: { page: Page; navigate: (page: Page) => void; className?: string; onClose?: () => void; projects: Project[]; selectedProjectId: string | null; setSelectedProjectId: Dispatch<SetStateAction<string | null>>; projectsLoading: boolean; projectsError: string; onCreateProject: (name: string) => Promise<Project> }) {
  return (
